// Base de datos oficial de Termales Jamanco (Papallacta, Ecuador)
// Basado en su página oficial de Facebook (@Terjamancoo) y sus 3 áreas turísticas: Terjamanco 1, Terjamanco 2 y El Mirador

export const TERJAMANCO_INFO = {
  name: "Termales Jamanco",
  alias: "Terjamanco Papallacta",
  logoType: "emblem", // "emblem" o "image"
  logoUrl: "",
...
// Las 3 Sedes y Circuitos Icónicos de Termales Jamanco
